...
exec 1>out/ze1klire_attrition_obs30_comms50_run1.out 2>&1
...
STEP_SIZE=0.02
UPDATE_RATE=100.0
PARAMS_FILE="/home/anthony/dev/patrolling_sim/params_obs30_comms50.yml"
OUTPUT_FILE="$HOME/papers/iros2024/sim_results/ze1klire_attrition_obs30_comms50_run1.zarr"
...
# MODEL_DIR="/home/anthony/dev/patrolling_zoo/onpolicy/scripts/results/Patrolling/milwaukee/mappo/partialObs400Depth10JKAggrAddComms0.1LR0.0003/wandb/run-20240312_144302-vzsjd8ki-partial/files"
...
for i in {1..3}; do
    ...
    ros2 launch patrolling_sim simulation.launch.py sim:=flatland step_size:=$STEP_SIZE update_rate:=$UPDATE_RATE algorithm_pkg:=patrol_algorithms_base algorithm_name:=SEBS agent_count:=$AGENTS use_rviz:=false headless:=true runtime:=$RUNTIME output:="$OUTPUT_FILE" attrition_times:="$ATTRITION_TIMES" agent_policy_dir:="$MODEL_DIR" params_file:="$PARAMS_FILE" monitor_pkg:="$MONITOR_PKG"
